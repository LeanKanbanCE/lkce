(function(a){a(document).ready(function(){a(window).load(function(){a("#st-container").removeClass("disable-scrolling");a("#loading-animation").fadeOut();a("#preloader").delay(350).fadeOut(800);var b=document.createElement("script");b.type="text/javascript";b.async=!0;b.src="http://apis.google.com/js/platform.js";var d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(b,d);equalheight(".same-height")});1500<a(window).width()&&a(".effect-wrapper").addClass("col-lg-3");768>a(window).width()&&
...
e=e.replace(/(^|[^\/])(www\.[\S]+(\b|$))/gim,'$1<a href="http://$2" target="_blank">$2</a>');e=e.replace(/#(\S*)/g,'<a href="http://twitter.com/search?q=%23$1" target="_blank">#$1</a>');e=e.replace(/\B@([\w-]+)/gm,'<a href="http://twitter.com/$1" target="_blank">@$1</a>');e='<div class="tweet animated fadeInUp hidden"><p class="tweet-text">'+e+'</p><p class="tweet-meta">by <a href="http://twitter.com/'+c.user.screen_name+'" target="_blank">@'+c.user.screen_name+"</a></p></div>";a("#tweets").append(e)});
...
l.length;a++)l[a].setMap(null);l=[]}function v(a){var b=c.getZoom(),d=Math.abs(a-b),e=a>b?1:-1;for(a=0;a<d;a++)setTimeout(function(){b+=e;c.setZoom(b)},50*(a+1))}function e(b){r.geocode({latLng:b},function(b,c){c==google.maps.GeocoderStatus.OK&&b[1]&&a.each(b[1].address_components,function(b,c){if("locality"==c.types[0])return a("#result-name").text(c.long_name),!1})})}n=new google.maps.DirectionsRenderer({suppressMarkers:!0});r=new google.maps.Geocoder;p=new google.maps.Polyline({strokeColor:"#f69f3c",
